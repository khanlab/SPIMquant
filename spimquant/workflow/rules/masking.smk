...
ruleorder: create_mask_from_gmm_and_prior > reslice_mask_to_level


rule reslice_mask_to_level:
    input:
        ref=bids(
            root=root,
            datatype="micr",
    ...
    conda:
        "../envs/c3d.yaml"
    shell:
        "c3d -interpolation NearestNeighbor {input.ref} {input.mask} -reslice-identity -o {output.mask}"
