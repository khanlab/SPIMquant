"""Concatenate subject-level parquet files across all subjects.
...
def main():
    ...
    # Save concatenated parquet file
    combined_data.to_parquet(snakemake.output.parquet, index=False)
